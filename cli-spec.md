# `reserve` CLI — command specification (v0.1, FROZEN)
...
`basis_consistent` (cumulative vs incremental declared/inferred),
`origin_dev_parseable`, `nonneg_incrementals` (warn only).
